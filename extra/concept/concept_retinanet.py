...
class ConceptRetinaNet(drigoniRetinaNet):
    ...
    def __init__(
     ...
     DATALOADER:
  NUM_WORKERS: 32           (100 is based on the limit established for the COCO dataset).
    ...
    def forward(self, batched_inputs: List[Dict[str, Tensor]]):
        ...
        # features:  [torch.Size([16, 256, 100, 168]), torch.Size([16, 256, 50, 84]), torch.Size([16, 256, 25, 42]), torch.Size([16, 256, 13, 21]), torch.Size([16, 256, 7, 11])]
